...
To contribute to zsh-templates project on [GitHub](https://github.com/hadenlabs/zsh-templates), We use Gitflow (See more [here](https://datasift.github.io/gitflow/IntroducingGitFlow.html)) In a nutshell, it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/zsh-templates/pulls).

![workflow gitflow](https://datasift.github.io/gitflow/GitFlowHotfixBranch.png)

## Getting started

To follow the instructions in this guide and start contributing to zsh-templates project on Gitlab:
...
```bash
git remote add upstream  https://github.com/hadenlabs/zsh-templates.git
```

Now your **upstream** points to **hadenlabs/zsh-templates**.
...
git fetch upstream # assuming upstream is hadenlabs/zsh-templates
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/zsh-templates/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
